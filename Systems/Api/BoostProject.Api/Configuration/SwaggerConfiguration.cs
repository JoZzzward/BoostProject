...
{
    private static readonly string _appTitle = "BoostProject Api";
    ...
    public static void UseAppSwagger(this WebApplication app, IAppSettings settings)
    {
        ...
        app.UseSwaggerUI(
            options =>
            {
                ...
                options.OAuthClientId(settings.IdentityClients.ApiClientId);
                options.OAuthClientSecret(settings.IdentityClients.ApiClientSecret);
            }
        );
    }
}
