        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondName = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    LastName = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    ImageUri = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    CreationDateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2023, 8, 8, 17, 33, 55, 187, DateTimeKind.Local).AddTicks(4469)),
                    ModificationDateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameRank = table.Column<string>(type: "text", nullable: false),
                    IsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    IsPrime = table.Column<bool>(type: "boolean", nullable: false),
                    IsSmurf = table.Column<bool>(type: "boolean", nullable: false),
                    GameHours = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: false),
                    Seen = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    CreationDateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ModificationDateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoosterId = table.Column<Guid>(type: "uuid", nullable: true),
                    Game = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersRoleOwners", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_UsersRoleOwners_AspNetUserRoles_UserId_RoleId",
                        columns: x => new { x.UserId, x.RoleId },
                        principalTable: "AspNetUserRoles",
                        principalColumns: new[] { "UserId", "RoleId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersRoleOwners_UserRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "UserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersRoleOwners_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersRoleOwners_RoleId",
                table: "UsersRoleOwners",
                column: "RoleId");
        }
